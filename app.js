...
App({
  ...
  globalData: {
    ...
    roles: [
      ...
      icon:'',chineseName:'提莫', zhiye:['神射手'],jiban:['灵魂莲华明昼']},
      {name:'Umi', cost: 3, fetter:['MYSTIC'], character: ['MINGZHOU'], 
      icon:'',chineseName:'悠米', zhiye:['秘术师'],jiban:['灵魂莲华明昼']},
      {name:'Kindred', cost: 3, fetter:['HUNTER'], character: ['MINGZHOU'], 
      icon:'',chineseName:'千珏', zhiye:['猎人'],jiban:['灵魂莲华明昼']},
      {name:'Ari', cost: 4, fetter: ['Mega'], character: ['MINGZHOU'], 
      icon:'',chineseName:'阿狸', zhiye:['魔法师'],jiban:['灵魂莲华明昼']},
